            ...
            <x-table.row>
                ...
                <x-table.cell data-label="Owner">
                    ...
                    <div class="text-gray-500">
                        <div>Item:<a href="tel:{{$item->owner?$item->owner->phone:''}}" class="mr-2">{{$item->owner?$item->owner->phone:''}}</a></div> 
                        <div class="my-1">Issued On:<span>{{$item->created_at->format('Y-m-d')}}</span></div> 
                    </div>
                ...
                <x-table.cell data-label="Warehouse">
                    ...
                    <div class="text-gray-500">
                        <div>Item:<span>{{$item->product?$item->product->item->name:''}}</span></div> 
                        <div class="my-1">Issued On:<span>{{$item->created_at->format('Y-m-d')}}</span></div> 
                    </div>
                </x-table.cell>
