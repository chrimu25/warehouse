<x-app-layout title="{{$item->item->name}} Checkin">
    ...
    <div class="bg-gray-100">
        <div class="min-h-screen sm:pt-0 bg-white rounded">
            ...
            action="{{ route('client.activity.checkin', $item->id) }}">
              @csrf
              ...
              <div class='my-5'>
                <div class='flex justify-between'>
                  <div class='w-full'>
                      <p>Previous Product Quantity</p>
                      <input type="text" value="{{$item->quantity}}" class="shadow appearance-none border rounded w-full py-2 px-3 
                      text-gray-700 leading-tight focus:outline-none focus:shadow-outline" disabled 
                      name="oldQuantity">
                    </div>
                  <div class="mx-3 w-full">
                      <p>New Product Quantity <span class="text-red-700">*</span></p>
                      <input type="number" class="shadow appearance-none border-gray-500 rounded w-full 
                      py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" 
                      name="newQuantity" autofocus min="1">
